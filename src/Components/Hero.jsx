...
{/* მარჯვენა მხარე hero სექციის  */}
    <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
      ...
      <div className="absolute z-[1] w-[80%] h-[80%] rounded-full bottom-40  blue__gradient"></div>
      
      {/* ორი ფერი ვიკმაროთ აქ */}

    </div>

    {/* აიფონისთვის get started არ ჩანდა და აქ ვამატებთ div-s იმისთვის, რომ გამოსაჩენი გახდეს ყველაფრისთვის */}
